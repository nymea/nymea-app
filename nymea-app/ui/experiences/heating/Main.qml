...
Item {
    ...
    readonly property string icon: Qt.resolvedUrl("qrc:qrc:/icons/radiator.svg")
    ...
    EmptyViewPlaceholder {
        ...
        imageSource: "qrc:qrc:/icons/radiator.svg"
        buttonVisible: false
            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    ColorIcon {
                        ...
                        name: "qrc:qrc:/icons/weathericons/wind.svg"
                ...
                RowLayout {
                    ColorIcon {
                        Layout.preferredHeight: Style.iconSize
                        Layout.preferredWidth: Style.iconSize
                        name: "qrc:qrc:/icons/sensors/temperature.svg"
                        color: Style.accentColor
                    }
                    Label {
            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    ColorIcon {
                        ...
                        Layout.preferredWidth: Style.iconSize
                        color: Style.accentColor
                        name: "qrc:qrc:/icons/ventilation.svg"
...
//            ProgressButton {
//                imageSource: "qrc:qrc:/icons/system-shutdown.svg"
//                Layout.preferredHeight: Style.iconSize * 1.5
//                Layout.preferredWidth: height
//                Layout.alignment: Qt.AlignHCenter
//            }
